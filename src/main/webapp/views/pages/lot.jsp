            ...
            <%--<div class="lot-info">--%>
                <%--<div class="lot-info-name">--%>
                    <%--<h3 id="lot-name">Phone </h3>--%>
                        <%--&lt;%&ndash;<script>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;console.log("one");&ndash;%&gt;--%>
                            <%--&lt;%&ndash;$.ajax({&ndash;%&gt;--%>
                                <%--&lt;%&ndash;url : '/nameProduct',&ndash;%&gt;--%>
                                <%--&lt;%&ndash;type : 'get',&ndash;%&gt;--%>
                                <%--&lt;%&ndash;contentType : 'application/json',&ndash;%&gt;--%>
                                <%--&lt;%&ndash;success : function (result) {&ndash;%&gt;--%>

                                        <%--&lt;%&ndash;let nameProduct = $('<div/>', {text : result.nameProduct});&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;console.log(result.nameProduct);&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;console.log('nameProduct :' + nameProduct);&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;result.appendTo('#conversationDiv' );&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;// '#conversationDiv'&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;},&ndash;%&gt;--%>
